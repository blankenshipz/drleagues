...
class LeaguesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create league" do
    assert_difference('League.count') do
      post leagues_url, params: { league: { name: @league.name, submission_deadline: @league.submission_deadline } }
    end
  ...
  test "should update league" do
    patch league_url(@league), params: { league: { name: @league.name, submission_deadline: @league.submission_deadline } }
