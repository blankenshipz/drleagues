...
class ModelsTest < ApplicationSystemTestCase
  ...
  test "creating a Model" do
    ...
    fill_in "Path", with: @model.path
    fill_in "Physical score", with: @model.physical_score
    fill_in "Team", with: @model.team_id
    fill_in "Virtual score", with: @model.virtual_score
